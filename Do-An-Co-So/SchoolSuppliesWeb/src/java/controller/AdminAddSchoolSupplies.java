 ...
 * @author HEALER
 */
public class AdminAddSchoolSupplies extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           SchoolSupplies schoolsupplies = new SchoolSupplies(schoolsuppliesId, categoryId, schoolsuppliesName, schoolsuppliesImage, schoolsuppliesPrice, schoolsuppliesDescription);
            ...
            SchoolSupplies checkSchoolSupplies = accountDAO.getSchoolSuppliesById(schoolsuppliesId);
            if (checkSchoolSupplies.getSchoolSuppliesID() != null) {
                response.sendRedirect("admin/addSchoolSupplies.jsp");
                return;
            }
            int n = accountDAO.insertSchoolSupplies(schoolsupplies);
